...
import priyan from "./priyan.jpg";
import suby from "./suby.jpg";
    ...
    <>
      <section class="home" id="home">
        <div class="content">
          ...
          <p>
            Our Job Is To Filling Your Tummy With Delicious <br />
      ...
      <section class="about" id="about">
        ...
        <div class="row">
          <div class="image">
            <img
              src="https://img.freepik.com/free-photo/delicious-fried-chicken-plate_144627-27383.jpg?w=1380&t=st=1673967239~exp=1673967839~hmac=24b720036ed06a5b5527d1ce4b05dc73239e14496a35270ff82c87e1f6beda5d"
              alt=""
            />
          </div>
      ...
      <div class="step-container">
        ...
        <section class="review" id="review">
          ...
          <div class="box-container">
            <div class="box">
              ...
              <p>
                The fastest way to search for great places to eat around you
              </p>
            </div>
            <div class="box">
              <img src={priyan} alt="" />
              ...
              <p>
                ...
                are amazing. Sending updates on your order is one of the finest
                thing{" "}
              </p>
            </div>
            <div class="box">
        ...
        <section class="footer">
          <div class="box-container">
            ...
            <div class="box">
              <h3>contact info</h3>
              <a href="#">+91 6238006085</a>
              <a href="https://mail.google.com/mail/u/0/?fs=1&tf=cm&source=mailto&to=swathiit01@gmail.com">
                swathiit01@gmail.com
              </a>
              <a href="https://en.wikipedia.org/wiki/Chennai">
                Chennai, India - 600000
              </a>
            </div>

            <div class="box">
              <h3>follow us</h3>
              <a href="https://www.instagram.com/___viswas__/">instagram</a>
              <a href="https://www.linkedin.com/in/swathi-ravi-28hemi/">
                linkedin
              </a>
            </div>
          </div>
